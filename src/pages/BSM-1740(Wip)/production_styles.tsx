...
type Style = {
  ...
  color: string;
  material: string;
  status: "Active" | "Limited" | "Archived";
};
            ...
            {styles.map((s) => (
              <tr key={s.id} className="border-t border-white/5">
                ...
                <td className="px-6 py-4">
                  <span className={`rounded-full px-3 py-1 text-xs ${s.status === "Active" ? "bg-white/5 text-white" : "bg-slate-700 text-white"}`}>
                    {s.status}
                  </span>
                </td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          >
            ...
            <div className="mt-6 flex justify-end gap-3">
              ...
              <button type="submit" className="rounded-md bg-orange-600 px-4 py-2 text-sm text-white">Add Style</button>
            </div>
          </form>
        </div>
      )}
