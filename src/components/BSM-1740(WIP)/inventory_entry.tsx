    ...
    <div className={`h-full w-full overflow-hidden ${page}`}>
        ...
        >
          <div className="flex items-start justify-between gap-4">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-white px-4 py-2 text-sm font-semibold text-slate-900 shadow-lg shadow-black/10 transition hover:translate-y-[-1px] hover:bg-slate-100 dark:bg-orange-500 dark:text-white dark:hover:bg-orange-400"
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className={`mt-2 w-full rounded-lg border px-3 py-2 text-sm transition focus:outline-none focus:ring-2 focus:ring-orange-500/50 ${input}`}
                  />
                </div>
                <div>
                  <label
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className={`w-full rounded-lg border px-3 py-2 text-sm transition focus:outline-none focus:ring-2 focus:ring-orange-500/50 ${input}`}
                  >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="0.00"
                        step="0.01"
                        className={`w-full rounded-lg border pl-6 pr-3 py-2 text-sm transition focus:outline-none focus:ring-2 focus:ring-orange-500/50 ${input}`}
                      />
                    </div>
                  </div>
                  <div>
                ...
                <button
                  type="submit"
                  className="w-full rounded-lg bg-white py-2.5 text-sm font-semibold text-slate-900 shadow-md transition hover:bg-slate-100 dark:bg-orange-500 dark:text-white dark:hover:bg-orange-400"
                >
                  Submit Entry
                </button>
              </form>
                  ...
                  {recentEntries.map((entry) => (
                    ...
                    >
                      ...
                      <td className={`px-6 py-3 text-sm`}>
                        <span
                          className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-bold ${entry.status === "In Stock" ? "bg-white text-slate-900 dark:bg-slate-900 dark:text-white" : "bg-red-500 text-white"}`}
                        >
                          {entry.status}
                        </span>
                      </td>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div
            className={`w-full max-w-md rounded-3xl border p-6 shadow-2xl ${card}`}
          >
            <div className="mb-4 flex items-start justify-between">
              ...
              <button
                ...
                className={`rounded-lg p-1 transition ${dark ? "hover:bg-white/10" : "hover:bg-slate-100"}`}
              >
                ✕
              </button>
            </div>
            ...
            >
              ...
              <div className="flex gap-3">
                <button
                  type="button"
                  onClick={() => setShowModal(false)}
                  className={`flex-1 rounded-lg border px-4 py-2.5 text-sm font-semibold transition ${dark ? "border-white/10 bg-white/5 text-white hover:bg-white/10" : "border-slate-200 bg-white text-slate-900 hover:bg-slate-100"}`}
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="flex-1 rounded-lg bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-slate-800 dark:bg-orange-500 dark:hover:bg-orange-400"
                >
                  Add Item
                </button>
              </div>
