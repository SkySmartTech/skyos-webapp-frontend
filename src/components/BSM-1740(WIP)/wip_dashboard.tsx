          ...
          {setupOpen && (
            <div className="mt-2 space-y-2 pl-5">
              <button
                ...
                className={`flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition ${activeSection === "setupLines" ? "text-orange-300 bg-white/5" : "text-slate-400 hover:text-white hover:bg-white/5"}`}
              >
                Lines
              </button>
              <button
                ...
                className={`flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition ${activeSection === "setupStyles" ? "text-orange-300 bg-white/5" : "text-slate-400 hover:text-white hover:bg-white/5"}`}
              >
                Styles
              </button>
            </div>
          ...
          {accessOpen && (
            <div className="mt-2 space-y-2 pl-5">
              <button
                ...
                className={`flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition ${activeSection === "accessUsers" ? "text-orange-300 bg-white/5" : "text-slate-400 hover:text-white hover:bg-white/5"}`}
              >
                Users
              </button>
              <button
                ...
                className={`flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition ${activeSection === "accessPermissions" ? "text-orange-300 bg-white/5" : "text-slate-400 hover:text-white hover:bg-white/5"}`}
              >
                Role & Permissions
              </button>
            </div>
