...
export default function Andon() {
  ...
  return (
    <div className={`min-h-full w-full p-6 transition-colors duration-300 ${bg}`}>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className={`rounded-xl shadow-sm p-6 border transition-colors duration-300 ${card}`}>
          <div className={`text-xs font-semibold uppercase tracking-widest mb-4 ${label}`}>
            Performance EFI
          </div>
